<!DOCTYPE html><html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <title> Merhaba {{ $user->fullname }} </title>
    <!--[if !mso]><!-- -->
...
<div
    ...
    Preview - Merhaba {{ $user->fullname }} </div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div
                                        style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                        Sayın <strong>{{ $user->fullname }}</strong>
                                        Rendavu Bilgileriniz aşağıda yer almaktadır
                                        <ul>
                                            <li>Kurum : <span>DentCare</span></li>
                                            <li>Doktor : <span>{{ $user->fullname }}</span></li>
                                            <li>Tedavi : <span>{{ $user->service->title }}</span></li>
                                            <li>Tarih :
                                                <span>{{ Carbon\Carbon::parse($user->appointment_date)->translatedFormat("d F Y") }} {{ Carbon\Carbon::parse($user->appointment_time)->translatedFormat("H:i") }}</span></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">Sorunlarınız ve önerileriniz buradan belirtebilirsiniz.</div>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                        <tbody><tr>
                                            <td align="center" bgcolor="#2e58ff" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#2e58ff;" valign="middle">
                                                <a  href="{{ route('front.contact') }}" style="display: inline-block; background: #2e58ff; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: bold; line-height: 30px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 30px;" target="_blank"> Iletişim </a>
                                            </td>
                                        </tr>
                                        </tbody></table>
                                </td>
